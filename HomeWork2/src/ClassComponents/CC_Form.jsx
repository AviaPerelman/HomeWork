...
export default class CCForm extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <form>
                    <Input_text message={this.state.lastNameMessage} type="text" label="Last name: " id="lastName" onFocus={this.ShowMessage} onBlur={this.HideMessage} />
                    <Input_text message={this.state.firstNameMessage} type="text" label="First name: " id="firstName" onFocus={this.ShowMessage} onBlur={this.HideMessage} />
                    <Input_text message={this.state.psychometricScoreMessage} type="number" label="Psychometric score: " id="psychometricScore" onFocus={this.ShowMessage} onBlur={this.HideMessage} />
